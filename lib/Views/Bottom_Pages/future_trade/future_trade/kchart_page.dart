...
import 'future_trade_depth_chart.dart';
import 'order_book_on_chart_page.dart';

class KChartPageFutureTrade extends StatefulWidget {
  const KChartPageFutureTrade({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  State<KChartPageFutureTrade> createState() => _KChartPageFutureTradeState();
}

class _KChartPageFutureTradeState extends State<KChartPageFutureTrade> {
        ...
        builder: (context, value, child) {
          ...
          return ListView(
            ...
            children: <Widget>[
              ...
              //             _infoColumn(
              //               context,
              //             AppLocalizations.of(context)!.twentyFourVolume, controller.volume24H.toString(),
              //             ),
              //             SizedBox(width: 15.sp),
              //             _infoColumn(
              //               context,
              //               AppLocalizations.of(context)!.twentyFourLow,
              //               controller.low24H.toString(),
              //             ),
              //           ],
              //         ),
              //       ),
                    ...
                    SizedBox(
                      ...
                      child: Stack(
                        children: [
                          ClipRect(
                              child:
                              FutureDepthChartView(pair: "${controller.coinOne}${controller.coinTwo}",)
                          ),
                        ],
                      ),
                    )
