...
class LivePriceRowFuture extends StatefulWidget {
  ...
  @override
  State<LivePriceRowFuture> createState() => LivePriceRowState();
}

class LivePriceRowState extends State<LivePriceRowFuture> {
  double? _previous;
  ...
  @override
  void didUpdateWidget(covariant LivePriceRowFuture oldWidget) {
