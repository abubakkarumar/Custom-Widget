          ...
          AnimatedCrossFade(
            ...
            firstChild: Column(
              ...
              children: [
                ...
                CustomText(
                  label:
                      "1 ${AppLocalizations.of(context)!.legendaryBlackRobotAvatar}",
                  align: TextAlign.start,
                ...
                CustomText(
                  label:
                      ...
                      " 5 ${AppLocalizations.of(context)!.blackSamuraiRobotAvatar}",
                  align: TextAlign.start,
                  labelFontWeight: FontWeight.w300,
                  lineSpacing: 5.sp,
                  fontSize: 15.sp,
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      flex: 3,
                      child: _InfoCard(
                        title:AppLocalizations.of(context)!.legendaryBlackRobotAvatar,
                        count: count,
...
class _InfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Widget badgeWidget = badge != null
        ...
        : (count != null
              ? ReferralCountBadge(label: count.toString(), size: 20.sp)
